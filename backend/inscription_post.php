                            ...
                            if (preg_match($regex, $nom))
                                {
                                    if (preg_match($regex, $prenom))
                                        ...
                                        $erreur['caract_p'] = "La première lettre du prénom n'est pas en majuscule ou caractère.s non autorisé.s utilisé.s";
                                        }
                                }
                            else{
                                    $erreur['caract_n'] = "La première lettre du nom n'est pas en majuscule ou caractère.s non autorisé.s utilisé.s";
                                }
                        }         
                    else
                        {
